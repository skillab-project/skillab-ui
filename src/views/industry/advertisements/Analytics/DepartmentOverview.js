...
export default function DepartmentOverview({ deptId }) {
    ...
    useEffect(() => {
        if (!deptId) { setStats(null); return; }
        let ignore = false;
        setLoading(true); setErr('');
        fetch(`${base}/statistics/department/${deptId}`, { headers: { Accept: 'application/json', Authorization: `Bearer ${localStorage.getItem("accessTokenSkillab")}` } })
